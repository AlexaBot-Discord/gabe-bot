exports.run = (client, msg, args) => {
    var comandos = 19;
    var cmds = Math.floor(comandos - 3);
    msg.delete();
        ...
        fields: [
            {
                ...
                name: "**$nivel**",
                value: "➤ Saiba seu nível no meu sistema de pontos! [Sugestão: Rannii#2991]"
            },{
                name: "**$pontos**",
                value: "➤ Saiba seus pontos no meu sistema de pontos! [Sugestão: Rannii#2991]"
            }
        ]
}}).then(m => m.pin());
}